...
GO
ALTER TABLE [Sales].[Invoices] ADD CONSTRAINT [PK_Sales_Invoices] PRIMARY KEY CLUSTERED  ([InvoiceID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Invoices_AccountsPersonID] ON [Sales].[Invoices] ([AccountsPersonID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Invoices_BillToCustomerID] ON [Sales].[Invoices] ([BillToCustomerID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [IX_Sales_Invoices_ConfirmedDeliveryTime] ON [Sales].[Invoices] ([ConfirmedDeliveryTime]) INCLUDE ([ConfirmedReceivedBy]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Invoices_ContactPersonID] ON [Sales].[Invoices] ([ContactPersonID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Invoices_CustomerID] ON [Sales].[Invoices] ([CustomerID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Invoices_DeliveryMethodID] ON [Sales].[Invoices] ([DeliveryMethodID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Invoices_OrderID] ON [Sales].[Invoices] ([OrderID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Invoices_PackedByPersonID] ON [Sales].[Invoices] ([PackedByPersonID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Invoices_SalespersonPersonID] ON [Sales].[Invoices] ([SalespersonPersonID]) ON [USERDATA]
GO
