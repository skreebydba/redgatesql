...
GO
ALTER TABLE [Sales].[SpecialDeals] ADD CONSTRAINT [PK_Sales_SpecialDeals] PRIMARY KEY CLUSTERED  ([SpecialDealID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_SpecialDeals_BuyingGroupID] ON [Sales].[SpecialDeals] ([BuyingGroupID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_SpecialDeals_CustomerCategoryID] ON [Sales].[SpecialDeals] ([CustomerCategoryID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_SpecialDeals_CustomerID] ON [Sales].[SpecialDeals] ([CustomerID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_SpecialDeals_StockGroupID] ON [Sales].[SpecialDeals] ([StockGroupID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_SpecialDeals_StockItemID] ON [Sales].[SpecialDeals] ([StockItemID]) ON [USERDATA]
GO
