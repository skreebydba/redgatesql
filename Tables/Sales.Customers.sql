...
GO
CREATE CLUSTERED INDEX [ix_Customers_Archive] ON [Sales].[Customers_Archive] ([ValidTo], [ValidFrom]) WITH (DATA_COMPRESSION = PAGE) ON [USERDATA]
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Customers_AlternateContactPersonID] ON [Sales].[Customers] ([AlternateContactPersonID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Customers_BuyingGroupID] ON [Sales].[Customers] ([BuyingGroupID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Customers_CustomerCategoryID] ON [Sales].[Customers] ([CustomerCategoryID]) ON [USERDATA]
GO
ALTER TABLE [Sales].[Customers] ADD CONSTRAINT [UQ_Sales_Customers_CustomerName] UNIQUE NONCLUSTERED  ([CustomerName]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Customers_DeliveryCityID] ON [Sales].[Customers] ([DeliveryCityID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Customers_DeliveryMethodID] ON [Sales].[Customers] ([DeliveryMethodID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [IX_Sales_Customers_Perf_20160301_06] ON [Sales].[Customers] ([IsOnCreditHold], [CustomerID], [BillToCustomerID]) INCLUDE ([PrimaryContactPersonID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Customers_PostalCityID] ON [Sales].[Customers] ([PostalCityID]) ON [USERDATA]
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Customers_PrimaryContactPersonID] ON [Sales].[Customers] ([PrimaryContactPersonID]) ON [USERDATA]
GO
